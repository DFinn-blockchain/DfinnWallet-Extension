...
const Component = ({ className }: Props) => {
  ...
  const ListTermSeedPhrase: Record<TermSeedPhrase, string> = useMemo(() => ({
    [TermSeedPhrase.TERM_1]: t('DFinnwallet doesn\'t keep any copy of your seed phrase and other backup methods such as JSON file or private key.'),
    [TermSeedPhrase.TERM_2]: t('DFinnwallet can\'t help you recover your account once your seed phrase, JSON file or private key is lost.'),
